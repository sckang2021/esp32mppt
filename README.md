...
![输入图片说明](images/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20230715161543.png)

![输入图片说明](images/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20230715161601.png)
...
建议先烧录https://gitee.com/muyan3000/esp32-mppt/tree/master/esp32_buck_boost/firmware/i2cdetect.bin，I2C检测程序，检查INA226的地址是否正确
...
修改输出控制逻辑，除使用时间控制时，休眠失效，其他控制模式都会继续使用深度休眠功能，也就是例如：使用常开模式，未进入休眠模式，则输出保持常开，当进入休眠，则关闭输出（此处，如果设定低电平开启，则在休眠状态会输出高电平，但是电平电压为1.6v左右）
...
IUV buck模式下, 输入电压低于电池电压；boost模式下，输入电压高于输出电压
